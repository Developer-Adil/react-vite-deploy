...
const About = () => {
  const skills = [
    { name: "Star", icon: Star, color: "#61DAFB" },
    { name: "BarChart3", icon: BarChart3, color: "#000000" },
    { name: "LineChart", icon: LineChart, color: "#3178C6" },
    { name: "DataBase", icon: Database, color: "#06B6D4" },
    { name: "TrendingUp", icon: TrendingUp, color: "#339933" },
    { name: "FileSpreadSheet", icon: FileSpreadsheet, color: "#47A248" },
  ];
  return (
            ...
            <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-white/70 leading-relaxed">
                        Business Analytics – Using data to improve business
                        decisions, forecast trends, and optimize operations.
                        Data Visualization – Creating charts, dashboards, and
                        visual stories to make data insights easy to understand.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">
                    Using statistical models and machine learning to predict
                    future outcomes.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">
                    Working with huge datasets using tools like Hadoop, Spark,
                    or cloud platforms.
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-white/60">
                Technologies I worked to build amazing products
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl ">
              {skills.map((skill, index) => (
                <div key={index} className="group relative bg-white/5 hover:bg-white/10 border border-white/10 hover:border-primary/50 rounded-2xl p-6 flex flex-col items-center justify-center gap-3 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="absolute inset-0 bg-linear-to-br from primary/0 to-primary/0 group:hover-from-primary/10 group:hover-primary/10 rounded-2xl transition-all duration-300"></div>
                </div>
              ))}
            </div>
          </div>
