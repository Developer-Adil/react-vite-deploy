      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4 max-w-2xl mx-auto">Built for Innovations. Designed for results.</h2>
            <p className="text-lg text-white/60 mx-auto max-w-xl">Comprehensive solutionns to transform your ideas into exceptional digital experiences. </p>
          </div>
        </FadeIn>
                ...
                return (
                    <FadeIn key={service.id} delay={100 + index * 100}>
                        <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-[280px] flex flex-col  ">
                            <div className="mb-6">
                                <div className="w-16 h-16 rounded-2xl bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:scale-100 transition-transform duration-300">
            ...
            {services.slice(2).map((service, index)=>{
                ...
                return (
                    <FadeIn key={service.id} delay={300 + index * 100}>
                        <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-[280px] flex flex-col  ">
                            <div className="mb-6">
                                <div className="w-12 h-12 rounded-xl bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:scale-100 transition-transform duration-300">
